...
int main( int argc, char *argv[] )
{
    try {
        ...
        /* Fork */
        {
            ...
            ChildProcess container_process( "proxyshell", [&]() {
        ...
        /* do the actual proxying in a different unprivileged child */
        outer_event_loop.add_child_process( "proxy", [&]() {
                drop_privileges();
